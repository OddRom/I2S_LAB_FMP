...
#define Anl_1_Pin GPIO_PIN_1
#define Anl_1_GPIO_Port GPIOA
#define MIC_L_Pin GPIO_PIN_2
#define MIC_L_GPIO_Port GPIOA
#define MIC_R_Pin GPIO_PIN_3
#define MIC_R_GPIO_Port GPIOA
